...
use falcon_aadhaar::{
    age_proof::nova::OP_CODE_LAST, proof_possession_incremental::AggregatedProofOfPossessionCircuit,
};
...
type C1 = AggregatedProofOfPossessionCircuit<<E1 as Engine>::Scalar>;
...
fn main() {
    ...
    let proof_json_path = "proof_possession.json";
