...
// use falcon_rust::{MODULUS, N, Polynomial, Signature, PublicKey, KeyPair};
...
//         left_shift_bytes,
//     }, hash::shake256::{
//         SHAKE256_BLOCK_LENGTH_BITS, SHAKE256_BLOCK_LENGTH_BYTES, SHAKE256_DIGEST_LENGTH_BITS, SHAKE256_DIGEST_LENGTH_BYTES, library_shake_256, library_step_sponge, shake256_gadget, shake256_inject, shake256_msg_blocks, shake256_pad101
//     }, qr::{AadhaarQRData, parse_aadhaar_qr_data}, utils::{bits_to_bytes_le, bytes_to_bits_le}
// };
...
//         Self {
//             opcode: 0u64,
//             next_shake_opcode: 0u64,
//             msg: [0u8; SHAKE256_BLOCK_LENGTH_BYTES],
//             dob_byte_index: 0,
//             l2_norm_sum: 0u64,
//             ctx_absorb: [0u8; SHAKE256_DIGEST_LENGTH_BYTES],
//             hash_c: Scalar::default(),
//             shake_inject_m: Scalar::default(),
//             c: [0u16; N],
//             // ctx_squeeze: [0u8; SHAKE256_DIGEST_LENGTH_BYTES],
//             // ctx_inject: [0u8; SHAKE256_DIGEST_LENGTH_BYTES],
//             s2: Polynomial::default(),
//             s2_chunk: [Scalar::default(); 68],
//             bit_array: [false; 68],
...
// {
//     fn update_nullifier(prev_nullifier: Scalar, current_msg_block: &[u8]) -> Scalar {
//         assert_eq!(current_msg_block.len(), SHAKE256_BLOCK_LENGTH_BYTES);

//         let msg_blocks_bits = bytes_to_bits(current_msg_block);
...
//         let shake_inject_m_bytes: [u8; SHAKE256_DIGEST_LENGTH_BYTES] = library_shake_256(&padded_msg_bytes, SHAKE256_DIGEST_LENGTH_BYTES).try_into().unwrap();
...
//         vec![initial_opcode, hash_c, shake_inject_m, current_date_scalar]
//     }
...
//         let mut shake_msg_blocks: Vec<[u8; 136]> = shake256_msg_blocks(&aadhaar_qr_data.signed_data);
...
//         let first_next_shake_opcode = if shake_msg_blocks.len() > 1 {
//             OP_SHAKE256_ACTIVE
//         } else {
//             OP_SHAKE256_NO_OP
//         };

//         let msg_bytes = aadhaar_qr_data.signed_data.clone();
//         let msg_bits = shake256_pad101(&msg_bytes);
//         let msg = bits_to_bytes_le(&msg_bits).try_into().unwrap();
...
//         //         .try_into()
//         //         .unwrap();
//         let ctx_absorb = [0u8; SHAKE256_DIGEST_LENGTH_BYTES];
//         let l2_norm_sum = 0u64;
//         // First step
//         aadhaar_steps.push(Self {
//             opcode: first_opcode,
//             next_shake_opcode: first_next_shake_opcode,
//             msg: msg_blocks[0],
//             dob_byte_index: aadhaar_qr_data.dob_byte_index,
//             l2_norm_sum: l2_norm_sum,
//             ctx_absorb: ctx_absorb,
//             // ctx_squeeze: [0u8; SHAKE256_DIGEST_LENGTH_BYTES],
//             // ctx_inject: [0u8; SHAKE256_DIGEST_LENGTH_BYTES],
//             s2: s2.clone(),
//             s2_chunk: [Scalar::default(); 68],
...
//         prev_nullifier = Self::update_nullifier(prev_nullifier, &msg_block_without_timestamp);
