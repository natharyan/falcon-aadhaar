//! packing k R1CS instances over GoldilocksFq into one R1CS instance over GoldilocksRingNTT.
//! this is Remark 4.1 of the LatticeFold paper for a uniform IVC (matrices A,B,C are the same for each step).
